...
**14 models on Hugging Face · ~7,800 downloads/month.**

*Open to ML Engineer roles (inference optimization, model compression, edge deployment) — DFW or remote.*

## Projects

**[Bible AI Assistant](https://github.com/t-timms/bible-ai-assistant)** — Local Scripture Q&A on a 16 GB card: hybrid RAG over 31k verses feeding an SFT fine-tune plus a *verifiable* citation reward (GRPO) — the cited verse must exist in the index and the quote must match. sha256-pinned benchmark protocol, 466 tests, full CI/CD. Primary project — building toward local SOTA on a 5070 Ti.
